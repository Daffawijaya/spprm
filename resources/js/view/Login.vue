<template>
    <div
        class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-white px-4"
    >
        <div class="max-w-6xl w-full grid md:grid-cols-2 gap-8 items-center">
            <!-- Ilustrasi -->
            <div class="hidden md:flex justify-center">
                <img
                    src="http://localhost:8000/image/ilus.png"
                    alt="Ilustrasi Login"
                    class="w-[80%]"
                />
            </div>
            ...
            <!-- Card Login -->
            <div
                class="bg-white rounded-2xl shadow-xl px-10 py-10 w-full max-w-md mx-auto flex flex-col"
            >
                ...
                <form @submit.prevent="handleLogin" class="space-y-5 w-full">
                    <div>
                        ...
                        >
                        <div
                            class="flex items-center bg-[#F3F5FD] rounded-full px-4 py-2"
                        >
                    ...
                    <div>
                        ...
                        >
                            ...
                            <EyeIcon
                                v-if="!showPassword"
                                class="w-5 h-5 text-gray-700 cursor-pointer ml-2"
                ...
                <div class="mt-8 flex justify-center items-center gap-2">
                    <img
                        src="http://localhost:8000/image/LOGOdKKRI.png"
                        alt="Logo"
                        class="h-7 object-contain"
                    />
                    <img
                        src="http://localhost:8000/image/Rectangle486.png"
                        alt="Rect"
                        class="h-7 object-contain"
                    />
                </div>
