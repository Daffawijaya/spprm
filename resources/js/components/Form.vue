    ...
    >
        ...
        <div class="md:col-span-2">
            ...
            <textarea
                ...
                rows="3"
                placeholder="Isi riwayat medis pasien jika ada"
                class="w-full rounded-md bg-[#F3F5FD] text-gray-800 px-4 py-2 placeholder-[#CCCCCC] focus:outline-none focus:ring-2 focus:ring-[#ADDC8B]"
            ></textarea>
        </div>

        <!-- Tombol Simpan -->
        <div class="md:col-span-2 flex justify-end">
            <PrimaryButton type="submit" color="green"> Simpan </PrimaryButton>
        </div>
    </form>
</template>
